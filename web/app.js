...
function renderAnswer(parsed, chunks) {
  ...
  for (const cit of validCitations) {
    ...
    const verbatim = document.createElement('div');
    verbatim.className = 'verbatim-text';
    // content_html is generated by our own build pipeline — safe to set as innerHTML.
    // The LLM only supplies section_id references; it never controls this content.
    verbatim.innerHTML = chunk.content_html;
